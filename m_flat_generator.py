...
for i, _filter in enumerate(flat_filters):
    flat_list = ifc_flat.files_filtered(imagetyp=flat_image_type, filter=_filter, include_path=True)
    ...
    flat_file_name = 'master_flat_{}.fits'.format(_filter.replace("''", "p")) # maybe f-string? 
